...
QuestItemDB = {
   ...
   [2] = {
      1172,
      "This is one of the few equippable items in the game that emits its own light source. It is worth hanging on to if you are into roleplaying at all.",
	  104,
	  "A",
      nil
   },
   [3] = {
      16788,
      "A shield with the model of a ships wheel. Worth keeping for any aspiring roleplayers looking to complete their pirate set.",
      104,
      nil,
      nil
   },
   ...
   [9] = {
      19141,
      "Removing bleed effects is generally not possible without a Paladin bubble, which makes this trinket very unique. There are some limited uses in PvE (e.g. Core Hounds in Molten Core) though It is probably more useful for PvP twinks to use vs. Warriors/Rogues.",
      7727,
      nil,
      nil
   },
   ...
   [12] = {
      11902,
      "This is an extremely unique trinket with a ranged stun/disarm effect which can see use in PvP. It is also an item which Paladins can use to assist with ranged pulls when tanking.",
      3962,
      nil,
      nil
   },
   ...
   [17] = {
      5421,
      "This is the only quest which offers a unique weapon enchant as a reward. It is not possible to acquire this enchant by any other means, and you only get one 'copy' to use per character. Save it if you plan on doing any AoE tanking/farming to use on your weapon at lvl 60.",
      706,
      nil,
      nil
   },
   ...
   [19] = {
      13966,
      "It is strongly recommended that all Druids take this trinket as it is the best-in-slot trinket for bear tanks through all Vanilla content and will never be replaced. If you want to keep your options open for tanking, take this as your reward.",
      5102,
      nil,
      "Druid"
   },
   ...
   [23] = {
      20512,
      "Items that offer crit for both spells and melee are extremely hard to come by, making this trinket quite unique. It is useful both offensively and defensively, for damage as well as healing, making this a great item all round. It is likely to be replaced in the long run, however It is a great trinket for levelling and early level 60. Always take this.",
      8418,
      "A",
      "Paladin"
   },
   ...
   [28] = {
      19990,
      "This is a fantastic trinket for healing and will be useful even at level 60. Trinkets that give an on-use bonus to healing are very hard to come by, so It is absolutely worth taking this over the other possible rewards, even if you plan to go shadow.",
      8257,
      nil,
      "Priest"
   },
   ...
   [32] = {
      20503,
      "An excellent trinket, giving you an additional Mana Spring Totem to cast every three minutes. It is free to cast, grants more mana than an improved Mana Spring Totem, and doesn't interrupt your MP5 regen window when cast. Useful in dungeons and raids at 60 - make sure you take this item over the other two.",
      8413,
      "H",
      "Shaman"
   },
   [33] = {
      15108,
      "Despite its low level, this is an excellent offhand for Warlocks. It is comparable to the pre-BiS options which are usually items with the '...of Shadow Wrath' suffix making them difficult (or expensive) to obtain. It is highly recommended that you take this item over the staff.",
      4964,
      nil,
      "Warlock"
   },
   [34] = {
      20536,
      "One of the most awesome weapon models for Warlocks. The downside is that the weapon will be replaced relatively quickly upon reaching lvl 60. The main reason to take this is for looks rather than the stats. There isn't really a right answer between taking this vs. the trinket - It is down to preference.",
      8422,
      nil,
      "Warlock"
   },
   ...
   [36] = {
      6972,
      "This is essentially a reusable Rage Potion. It is somewhat limited due to the long one hour cooldown, but probably the most useful application is to use this along with similar items to build rage prior to a boss pull for maximum threat during the first few seconds.",
      1782,
      "A",
      "Warrior"
   },
   ...
   [44] = {
      15411,
      "This is a fantastic pre-BiS neck piece for Fury which isn't replaced until you get the Onyxia Tooth Pendant. It is comparable to the Eye of Hakkar from Hakkar in ZG (Phase 4), having only 14 less attack power. It is strongly recommended that you take this over the chest, even if you plan on tanking 100%.",
      5944,
      nil,
      "Warrior"
   },
